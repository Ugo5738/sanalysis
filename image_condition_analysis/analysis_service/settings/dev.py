...
# Require Supabase/Postgres configuration in dev; no SQLite fallback
DATABASES = build_databases_from_env()
if not DATABASES:
    raise ImproperlyConfigured(
        "Supabase database is not configured. Set SUPABASE_DB_URL or SUPABASE_DB_HOST/PORT/NAME/USER/PASSWORD in .env"
    )
# ================================ DATABASES =======================================
